...
#define MARIO_TANUKI_SITTING_BBOX_WIDTH  20
...
#define MARIO_ADDSCORETIME		1000
...
#define TANUKI_SHELL_OFFSETX		10
...
public:
	...
	int IsBlocking() { return 0;/*return (state != MARIO_STATE_DIE && untouchable==0);*/ }
